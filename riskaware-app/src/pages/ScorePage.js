...
function ScorePage() {
  ...
  useEffect(() => {
    if (patientId) {
      fetch("https://6440-project-5vnbkxsym3hbzyy7stuk4w.streamlit.app/get_scores", {
        method: "POST",
  ...
  const getRecommendations = async () => {
    ...
    try {
      ...
      const response = await fetch("https://6440-project-5vnbkxsym3hbzyy7stuk4w.streamlit.app/recommendations", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
