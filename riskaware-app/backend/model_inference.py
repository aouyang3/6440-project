...
cancer_model = pickle.load(open('/mount/src/6440-project/riskaware-app/backend/cancer_model.pkl', 'rb'))
stroke_model = pickle.load(open('/mount/src/6440-project/riskaware-app/backend/stroke_model.pkl', 'rb'))
diabetes_model = pickle.load(open('/mount/src/6440-project/riskaware-app/backend/diabetes_model.pkl', 'rb'))
